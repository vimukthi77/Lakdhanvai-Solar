...
export default function NotificationsPage() {
  ...
  const [reportResult, setReportResult] = useState<{ email: boolean } | null>(null);
  ...
  // Trigger Full Morning Report (Email)
  const triggerMorningReport = async () => {
    ...
    try {
      ...
      if (result.success) {
        setReportResult({ email: result.notifications?.email });
        setLastPrediction({
          date: result.date,
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-slate-100">
      ...
      <main className="flex-1 overflow-auto">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-300 text-sm">Email Alerts • Real AI Data</p>
                </div>
              </div>
        ...
        <div className="p-6 lg:p-8 space-y-6">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-blue-300">
                    Fetch real prediction & send via Email
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-400 text-sm mt-1">
                  📧 Email to jayasooriyashehan4@gmail.com
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Email Card */}
          <div className="bg-white rounded-2xl p-6 border-2 border-blue-100 shadow-lg max-w-xl">
